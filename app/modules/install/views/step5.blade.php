...
@section('title')
{{ Lang::get('install/installer.installer') }} | {{ Lang::get('install/installer.step') }} 5 {{ Lang::get('install/installer.of') }} 5
@stop
@section('content')
<div id="install-region">
	...
	@endif
	<form method="post" style="text-align: center;" action="{{ url('install/step5') }}" class="form-horizontal">
		<p>
